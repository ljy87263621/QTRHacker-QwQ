...
}		public virtual bool Accessory
{
	...
	set => InternalObject.accessory = value;
...
}		public virtual bool Buy
{
	...
	set => InternalObject.buy = value;
}		public virtual bool BuyOnce
{
...
}		public virtual bool CartTrack
{
	...
	set => InternalObject.cartTrack = value;
...
}		public virtual bool Consumable
{
	...
	set => InternalObject.consumable = value;
}		public virtual bool DD2Summon
{
	get => InternalObject.DD2Summon;
	set => InternalObject.DD2Summon = value;
}		public virtual bool Expert
{
	get => InternalObject.expert;
	set => InternalObject.expert = value;
}		public virtual bool ExpertOnly
{
	get => InternalObject.expertOnly;
	set => InternalObject.expertOnly = value;
}		public virtual bool Favorited
{
	get => InternalObject.favorited;
	set => InternalObject.favorited = value;
}		public virtual bool Flame
{
...
}		public virtual bool IsAShopItem
{
	...
	set => InternalObject.isAShopItem = value;
}		public virtual bool Magic
{
	get => InternalObject.magic;
	set => InternalObject.magic = value;
}		public virtual bool Material
{
	get => InternalObject.material;
	set => InternalObject.material = value;
}		public virtual bool Mech
{
	get => InternalObject.mech;
	set => InternalObject.mech = value;
}		public virtual bool Melee
{
	get => InternalObject.melee;
	set => InternalObject.melee = value;
}		public virtual bool NewAndShiny
{
	get => InternalObject.newAndShiny;
	set => InternalObject.newAndShiny = value;
}		public virtual bool NoMelee
{
	get => InternalObject.noMelee;
	set => InternalObject.noMelee = value;
}		public virtual bool NotAmmo
{
	get => InternalObject.notAmmo;
	set => InternalObject.notAmmo = value;
}		public virtual bool NoUseGraphic
{
	get => InternalObject.noUseGraphic;
	set => InternalObject.noUseGraphic = value;
}		public virtual bool NoWet
{
	get => InternalObject.noWet;
	set => InternalObject.noWet = value;
}		public virtual bool Potion
{
	get => InternalObject.potion;
	set => InternalObject.potion = value;
}		public virtual bool QuestItem
{
	get => InternalObject.questItem;
	set => InternalObject.questItem = value;
}		public virtual bool Ranged
{
	get => InternalObject.ranged;
	set => InternalObject.ranged = value;
...
}		public virtual bool Social
{
	...
	set => InternalObject.social = value;
}		public virtual bool Summon
{
	get => InternalObject.summon;
	set => InternalObject.summon = value;
}		public virtual bool UniqueStack
{
	get => InternalObject.uniqueStack;
	set => InternalObject.uniqueStack = value;
}		public virtual bool UseTurn
{
	get => InternalObject.useTurn;
	set => InternalObject.useTurn = value;
}		public virtual bool Vanity
{
	get => InternalObject.vanity;
	set => InternalObject.vanity = value;
}		public virtual bool WornArmor
{
...
}		public virtual byte Dye
{
	...
	set => InternalObject.dye = value;
}		public virtual byte Paint
{
...
}		public virtual byte Prefix
{
	...
	set => InternalObject.prefix = value;
}		public virtual short GlowMask
{
	get => InternalObject.glowMask;
	set => InternalObject.glowMask = value;
}		public virtual short HairDye
{
	get => InternalObject.hairDye;
	set => InternalObject.hairDye = value;
}		public virtual short MakeNPC
{
	get => InternalObject.makeNPC;
	set => InternalObject.makeNPC = value;
...
}		public virtual int Axe
{
	...
	set => InternalObject.axe = value;
}		public virtual int Bait
{
	get => InternalObject.bait;
	set => InternalObject.bait = value;
}		public virtual int BodySlot
{
...
}		public virtual int CreateTile
{
	...
	set => InternalObject.createTile = value;
}		public virtual int CreateWall
{
	get => InternalObject.createWall;
	set => InternalObject.createWall = value;
}		public virtual int Crit
{
	get => InternalObject.crit;
	set => InternalObject.crit = value;
...
}		public virtual int DungeonPrice
{
	get => InternalObject.dungeonPrice;
	set => InternalObject.dungeonPrice = value;
}		public virtual int EclipseMothronPrice
{
	get => InternalObject.eclipseMothronPrice;
	set => InternalObject.eclipseMothronPrice = value;
}		public virtual int EclipsePostPlanteraPrice
{
	get => InternalObject.eclipsePostPlanteraPrice;
	set => InternalObject.eclipsePostPlanteraPrice = value;
}		public virtual int EclipsePrice
{
...
}		public virtual int FishingPole
{
	...
	set => InternalObject.fishingPole = value;
}		public virtual int Hammer
{
	get => InternalObject.hammer;
	set => InternalObject.hammer = value;
}		public virtual int HeadSlot
{
	get => InternalObject.headSlot;
	set => InternalObject.headSlot = value;
}		public virtual int HealLife
{
	get => InternalObject.healLife;
	set => InternalObject.healLife = value;
}		public virtual int HealMana
{
...
}		public virtual int HellPrice
{
	...
	set => InternalObject.hellPrice = value;
...
}		public virtual int ManaIncrease
{
	...
	set => InternalObject.manaIncrease = value;
}		public virtual int MaxStack
{
	get => InternalObject.maxStack;
	set => InternalObject.maxStack = value;
...
}		public virtual int QueenBeePrice
{
	...
	set => InternalObject.queenBeePrice = value;
}		public virtual int Rare
{
...
}		public virtual int ShadowOrbPrice
{
	get => InternalObject.shadowOrbPrice;
	set => InternalObject.shadowOrbPrice = value;
}		public virtual int Shoot
{
	get => InternalObject.shoot;
	set => InternalObject.shoot = value;
}		public virtual int ShopSpecialCurrency
{
...
}		public virtual int Stack
{
	...
	set => InternalObject.stack = value;
}		public virtual int StringColor
{
	get => InternalObject.stringColor;
	set => InternalObject.stringColor = value;
}		public virtual int TileBoost
{
	get => InternalObject.tileBoost;
	set => InternalObject.tileBoost = value;
}		public virtual int TileWand
{
...
}		public virtual int UseAmmo
{
	get => InternalObject.useAmmo;
	set => InternalObject.useAmmo = value;
}		public virtual int UseAnimation
{
	get => InternalObject.useAnimation;
	set => InternalObject.useAnimation = value;
}		public virtual int UseStyle
{
	get => InternalObject.useStyle;
	set => InternalObject.useStyle = value;
}		public virtual int UseTime
{
	get => InternalObject.useTime;
	set => InternalObject.useTime = value;
...
}		public virtual sbyte BackSlot
{
	...
	set => InternalObject.backSlot = value;
}		public virtual sbyte BalloonSlot
{
	get => InternalObject.balloonSlot;
	set => InternalObject.balloonSlot = value;
}		public virtual sbyte BeardSlot
{
	get => InternalObject.beardSlot;
	set => InternalObject.beardSlot = value;
}		public virtual sbyte FaceSlot
{
	get => InternalObject.faceSlot;
	set => InternalObject.faceSlot = value;
}		public virtual sbyte FrontSlot
{
	get => InternalObject.frontSlot;
	set => InternalObject.frontSlot = value;
}		public virtual sbyte HandOffSlot
{
	get => InternalObject.handOffSlot;
	set => InternalObject.handOffSlot = value;
}		public virtual sbyte HandOnSlot
{
	get => InternalObject.handOnSlot;
	set => InternalObject.handOnSlot = value;
}		public virtual sbyte NeckSlot
{
	get => InternalObject.neckSlot;
	set => InternalObject.neckSlot = value;
}		public virtual sbyte ShieldSlot
{
	get => InternalObject.shieldSlot;
	set => InternalObject.shieldSlot = value;
}		public virtual sbyte ShoeSlot
{
...
}		public virtual sbyte WaistSlot
{
	...
	set => InternalObject.waistSlot = value;
}		public virtual sbyte WingSlot
{
	get => InternalObject.wingSlot;
	set => InternalObject.wingSlot = value;
}		public virtual float KnockBack
{
	get => InternalObject.knockBack;
	set => InternalObject.knockBack = value;
}		public virtual float Scale
{
	get => InternalObject.scale;
	set => InternalObject.scale = value;
}		public virtual float ShootSpeed
{
